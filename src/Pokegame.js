...
export default class Pokegame extends Component {
  ...
  render() {
    ...
    let exp1=hand1.reduce((exp,currentElement)=>exp+currentElement.base_experience,0);//no idea
    let exp2=hand2.reduce((exp,currentElement)=>exp+currentElement.base_experience,0);
